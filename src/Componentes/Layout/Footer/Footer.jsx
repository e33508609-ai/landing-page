        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-4 text-sm leading-relaxed">
              ...
              Creamos experiencias excepcionales para tus usuarios.
            </p>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-3">
              <input
                ...
                className="px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-400 text-sm"
              />
              <Boton variant="primary" size="sm" className="w-full">
                Suscribirse
              </Boton>
            </div>
          </div>
